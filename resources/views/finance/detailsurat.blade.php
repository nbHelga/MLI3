...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Detail Pengajuan Dana</h1>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="text-lg font-bold text-green-600">
                {{ $surat->dana ? 'Rp ' . number_format($surat->dana, 0, ',', '.') : '-' }}
            </div>
        ...
        @if($surat->dokumen_pelengkap)
            <div class="mt-4">
                <a href="{{ route('finance.download', $surat->id) }}" 
    ...
    <div class="mt-6">
        <a href="{{ route('finance.list-surat') }}" 
