...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="bg-white p-6 rounded-lg shadow-md mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        {{-- <img class="mx-auto h-10 w-auto" src="{{ asset('logomli.jpg') }}" alt="MLI Store"> --}}
        <h2 class="mt-4 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Log in to your account</h2>
      </div>
