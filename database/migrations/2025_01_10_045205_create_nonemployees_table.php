...
return new class extends Migration
{
    ...
    {
        Schema::create('nonemployees', function (Blueprint $table) {
                ...
                $table->string('no_hp');
                $table->string('no_hp_rekan_1')->nullable();
                $table->string('no_hp_rekan_1_ket')->nullable();
    ...
    {
        Schema::dropIfExists('nonemployees');
    }
};
